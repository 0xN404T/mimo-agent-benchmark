...
MiMo Agent Benchmark can be deployed on Vercel so developers can test Xiaomi MiMo without managing a VPS.

## What this deployment provides

Serverless benchmark runner/dashboard API for MiMo coding tasks.
